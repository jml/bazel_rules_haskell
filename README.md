# Haskell rules for [Bazel](https://bazel.build/) [![Build Status](https://travis-ci.org/jml/bazel_rules_haskell.svg?branch=master)](https://travis-ci.org/jml/bazel_rules_haskell)
